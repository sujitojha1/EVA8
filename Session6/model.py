...
class Net(nn.Module):
    def __init__(self):
        ...
        self.convblock2 = nn.Sequential(
            nn.Conv2d(in_channels=32, out_channels=4*32, kernel_size=1, stride=1, padding=0, bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(4*32),
            nn.Conv2d(in_channels=4*32, out_channels=4*32, kernel_size=3, stride=1, padding=1, groups=4*32, bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(4*32),
            nn.Conv2d(in_channels=4*32, out_channels=32, kernel_size=1, stride=1, padding=0, bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(32),
