...
class Net(nn.Module):
    def __init__(self):
        ...
        self.convblock9 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.BatchNorm2d(6*64),
            nn.Conv2d(in_channels=6*64, out_channels=134, kernel_size=1, stride=1, padding=0, bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(134),
            nn.Dropout(dropout_value)
        ...
        self.shortcut2 = nn.Sequential(
            nn.Conv2d(64, 134, kernel_size=1, stride=1, padding=0, bias=False),
            nn.BatchNorm2d(134),
        )
